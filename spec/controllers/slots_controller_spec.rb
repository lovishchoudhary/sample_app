...
describe SlotsController do
  ...
  let(:valid_attributes) { { "date" => "2015-01-19" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved slot as @slot" do
        ...
        post :create, {:slot => { "date" => "invalid value" }}, valid_session
        assigns(:slot).should be_a_new(Slot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested slot" do
        ...
        Slot.any_instance.should_receive(:update).with({ "date" => "2015-01-19" })
        put :update, {:id => slot.to_param, :slot => { "date" => "2015-01-19" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the slot as @slot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Slot.any_instance.stub(:save).and_return(false)
        put :update, {:id => slot.to_param, :slot => { "date" => "invalid value" }}, valid_session
        assigns(:slot).should eq(slot)
      end
