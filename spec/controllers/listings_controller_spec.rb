...
describe ListingsController do
  ...
  let(:valid_attributes) { { "club_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved listing as @listing" do
        ...
        post :create, {:listing => { "club_id" => "invalid value" }}, valid_session
        assigns(:listing).should be_a_new(Listing)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested listing" do
        ...
        Listing.any_instance.should_receive(:update).with({ "club_id" => "1" })
        put :update, {:id => listing.to_param, :listing => { "club_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the listing as @listing" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Listing.any_instance.stub(:save).and_return(false)
        put :update, {:id => listing.to_param, :listing => { "club_id" => "invalid value" }}, valid_session
        assigns(:listing).should eq(listing)
      end
