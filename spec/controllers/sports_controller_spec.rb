  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sport as @sport" do
        ...
        post :create, {:sport => { "sport" => "invalid value" }}, valid_session
        assigns(:sport).should be_a_new(Sport)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sport" do
        ...
        Sport.any_instance.should_receive(:update).with({ "sport" => "MyString" })
        put :update, {:id => sport.to_param, :sport => { "sport" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sport as @sport" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sport.any_instance.stub(:save).and_return(false)
        put :update, {:id => sport.to_param, :sport => { "sport" => "invalid value" }}, valid_session
        assigns(:sport).should eq(sport)
      end
